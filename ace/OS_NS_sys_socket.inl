...
#if defined (INTEGRITY178B) && defined (ACE_USES_LH_LEONET)
#include "tcp-ip_interface.h"
namespace
{
  // dinhs: Temporarily disable the calls to LEONET functions
...
#endif /* INTEGRITY178B && ACE_USES_LH_LEONET */
...
#  if defined (ACE_WIN32)
  ACE_SOCKCALL_RETURN (::accept ((ACE_SOCKET) handle,
                       ...
                       ACE_HANDLE,
                       ACE_INVALID_HANDLE);
#  elif defined (INTEGRITY178B) && defined (ACE_USES_LH_LEONET)
#pragma message ("ACE_OS::accept -- INTEGRITY178 with LEONET")
  ACE_UNUSED_ARG (handle);
  ACE_UNUSED_ARG (addr);
  ACE_UNUSED_ARG (addrlen);
  ACE_NOTSUP_RETURN (-1);
  // dinhs: Temporarily disable the call to the LEONET library
...
#    endif /* VXWORKS */
#pragma message ("ACE_OS::accept -- calling OS accept")
...
ACE_OS::bind (ACE_HANDLE handle, struct sockaddr *addr, int addrlen)
{
  ...
  ACE_UNUSED_ARG (addrlen);
  ACE_NOTSUP_RETURN (-1);
  // dinhs: Temporarily disable the call to LEONET
//  ACE_UNUSED_ARG (addrlen);
...
ACE_OS::recv (ACE_HANDLE handle, char *buf, size_t len, int flags)
{
...
#elif defined (INTEGRITY178B) && defined (ACE_USES_LH_LEONET)
  // dinhs: Temporarily disable these socket APIs wrapper.
  ACE_UNUSED_ARG (handle);
  ACE_UNUSED_ARG (buf);
  ACE_UNUSED_ARG (len);
  ...
  // dinhs: Uncomment the following to use the LEONET functions
//  UINT4 read_len = 0;
